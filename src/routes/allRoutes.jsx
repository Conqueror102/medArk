...
import JobListing from "../pages/hopitals/JobListing";
import HospitalProfile from "../pages/hopitals/HospitalProfile";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/hospitaldash" element={<HospitalDashboardLayout />}>
            ...
            <Route path="applicationPage" element={<ApplicationsPage />} />
